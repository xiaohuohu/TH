...
BOOL	ReadFileMessage(INT16S File ,INT8S *message )
{
	...
	if(err!=OS_NO_ERR)
	{
		OSQPost(MsgQueue,"ReadData FromFile Sem Timeout!");		
		OSTimeDly(100);
		return FALSE;
	}
	...
	FS_FRead(&filemessage,sizeof(INT8S)*0x40,1,fp);
...
void	SysParaInit()
{
	int i=0;
	//第一轴
	g_Ini.lPulse[0]=36000;
	g_Ini.lPulse[1]=38500;
	g_Ini.lPulse[2]=36000;
	g_Ini.lPulse[3]=36000;
	g_Ini.lPulse[4]=36000;
	g_Ini.lPulse[5]=36000;
	g_Ini.fMM[0]=360.0;
	g_Ini.fMM[1]=219.8;
	g_Ini.fMM[2]=360.0;
	g_Ini.fMM[3]=360.0;
	g_Ini.fMM[4]=360.0;
	g_Ini.fMM[5]=360.0;
	g_Ini.lMaxSpeed[0]=2000;
	g_Ini.lMaxSpeed[1]=2000;
	g_Ini.lMaxSpeed[2]=2000;
	g_Ini.lMaxSpeed[3]=2000;
	g_Ini.lMaxSpeed[4]=2000;
	g_Ini.lMaxSpeed[5]=2000;
	g_Ini.lHandSpeed[0]=50;
	g_Ini.lHandSpeed[1]=50;
	g_Ini.lHandSpeed[2]=50;
	g_Ini.lHandSpeed[3]=50;
	g_Ini.lHandSpeed[4]=50;
	g_Ini.lHandSpeed[5]=50;
	g_Ini.fBackSpeed[0]=60;
	g_Ini.fBackSpeed[1]=60;
	g_Ini.fBackSpeed[2]=60;
	g_Ini.fBackSpeed[3]=60;
	g_Ini.fBackSpeed[4]=60;
	g_Ini.fBackSpeed[5]=60;
	g_Ini.lGearRate[0]=10.0;
	g_Ini.lGearRate[1]=2.5;
	g_Ini.lGearRate[2]=3.0;
	g_Ini.lGearRate[3]=1.0;
	g_Ini.lGearRate[4]=1.0;
	g_Ini.lGearRate[5]=1.0;
	g_Ini.iRunDir[0]=1;
	g_Ini.iRunDir[1]=0;
	g_Ini.iRunDir[2]=0;
	g_Ini.iRunDir[3]=0;
	...
	g_Ini.iAxisSwitch[4]=1;
	g_Ini.iAxisSwitch[5]=1;
	g_Ini.iLag[0] = 0;
	g_Ini.iLag[1] = 0;
	g_Ini.iLag[2] = 0;
	g_Ini.iLag[3] = 0;
	g_Ini.iLag[4] = 0;
	g_Ini.iLag[5] = 0;
	g_Ini.iNumerator[0]=1;
	g_Ini.iNumerator[1]=1;
	g_Ini.iNumerator[2]=1;
	g_Ini.iNumerator[3]=1;
	g_Ini.iNumerator[4]=1;
	g_Ini.iNumerator[5]=1;
	g_Ini.iDenominator[0]=1;
	g_Ini.iDenominator[1]=1;
	g_Ini.iDenominator[2]=1;
	g_Ini.iDenominator[3]=1;
	g_Ini.iDenominator[4]=1;
	g_Ini.iDenominator[5]=1;
	...
	g_Ini.lRunSpeed[1] = 5;
	g_Ini.lRunSpeed[2] = 30;
	g_Ini.lRunSpeed[3] = 30;
	g_Ini.lRunSpeed[4] = 30;
	g_Ini.lRunSpeed[5] = 30;
	g_Ini.iStepDis[0]=10;
	g_Ini.iStepDis[1]=10;
	g_Ini.iStepDis[2]=10;
	g_Ini.iStepDis[3]=10;
	...
	g_Ini.iStepDis[5]=10;
	//g_Ini.lMM[i]=3600;
	g_Ini.fStartOffset[0]=0.0;
	g_Ini.fStartOffset[1]=0.0;
	g_Ini.fStartOffset[2]=0.0;
	g_Ini.fStartOffset[3]=0.0;
	g_Ini.fStartOffset[4]=0.0;
	g_Ini.fStartOffset[5]=0.0;
	g_Ini.lChAddSpeed[0]=3000;
	g_Ini.lChAddSpeed[1]=3000;
	g_Ini.lChAddSpeed[2]=3000;
	g_Ini.lChAddSpeed[3]=3000;
	g_Ini.lChAddSpeed[4]=3000;
	g_Ini.lChAddSpeed[5]=3000;
	g_Ini.iSearchZero[0]=1;
	g_Ini.iSearchZero[1]=1;
	g_Ini.iSearchZero[2]=1;
	g_Ini.iSearchZero[3]=1;
	g_Ini.iSearchZero[4]=1;
	g_Ini.iSearchZero[5]=1;
	g_Ini.iServoLogic[0]=1;
	g_Ini.iServoLogic[1]=1;
	g_Ini.iServoLogic[2]=1;
	g_Ini.iServoLogic[3]=1;
	g_Ini.iServoLogic[4]=1;
	g_Ini.iServoLogic[5]=1;
	g_Ini.iAxisRunMode[0]=0;
	g_Ini.iAxisRunMode[1]=0;
	g_Ini.iAxisRunMode[2]=0;
	g_Ini.iAxisRunMode[3]=0;
	g_Ini.iAxisRunMode[4]=0;
	g_Ini.iAxisRunMode[5]=0;
	g_Ini.iAxisMulRunMode[0]=0;
	g_Ini.iAxisMulRunMode[1]=0;
	g_Ini.iAxisMulRunMode[2]=0;
	g_Ini.iAxisMulRunMode[3]=0;
	g_Ini.iAxisMulRunMode[4]=0;
	g_Ini.iAxisMulRunMode[5]=0;
	g_Ini.fMaxLimit[0]=0.;
	g_Ini.fMaxLimit[1]=0.;
	g_Ini.fMaxLimit[2]=0.;
	g_Ini.fMaxLimit[3]=0.;
	...
	g_Ini.fMinLimit[4]=0.;
	g_Ini.fMinLimit[5]=0.;
	g_Ini.iAxisNameNo[0]=0;
	g_Ini.iAxisNameNo[1]=0;
	g_Ini.iAxisNameNo[2]=0;
	g_Ini.iAxisNameNo[3]=0;
	g_Ini.iAxisNameNo[4]=0;
	g_Ini.iAxisNameNo[5]=0;
	g_Ini.iHardLimitSwitch[0]=0;
	g_Ini.iHardLimitSwitch[1]=0;
	g_Ini.iHardLimitSwitch[2]=0;
	g_Ini.iHardLimitSwitch[3]=0;
	g_Ini.iHardLimitSwitch[4]=0;
	g_Ini.iHardLimitSwitch[5]=0;
	g_Ini.iPhyAxis[0]=0;
	g_Ini.iPhyAxis[1]=0;
	g_Ini.iPhyAxis[2]=0;
	g_Ini.iPhyAxis[3]=0;
	...
	g_Ini.iBackOrder[0]=1;
	g_Ini.iBackOrder[1]=2;
	g_Ini.iBackOrder[2]=3;
...
//	g_Ini.iAxisZero[5]=0;
	...
	g_Ini.lRotatorRate = 0;										//初始化为0，转线轴没有带动送线轴转动

	g_Ini.iColorStyle = 2;

	g_Ini.iCyldMode = 0;
	g_Ini.iCyldOrOrigin = 0;
	...
	g_Ini.iIORunLineConfig_IN=18;		//跑线报警端口
	g_Ini.iIOWireAccConfig_OUT=7;		//线架加速输出端口
	g_Ini.iIOSafeDoorConfig_IN=19;		//安全门输入端口
	g_Ini.iIOSart_IN=62;				//外部启动输入端口
	g_Ini.iIOSingleConfig_IN=19;		//外部单条输入端口
	g_Ini.iIOAlarmConfig_OUT=6;			//报警输出端口
	g_Ini.iIOSendLinePConfig_IN=14;		//送线+输入端口
	g_Ini.iIOSendLineMConfig_IN=13;		//送线-输入端口
	g_Ini.iTestFuction=0;				//特殊测试按键(0-禁用,1-启用)
	g_Ini.iWorkAxisNo=0;				//A轴补偿轴号(0-6轴 0-禁用 1-6补偿轴号 )
	g_Ini.iWorkAxisTMolecular=0;		//补偿分子(0-999999)
	g_Ini.iWaitSignal = 0;			    //配置探针端口做等待信号 0:无效 1-8Pro端口
	g_Ini.iProDelay=2000;					//输入等待时间 单位ms
	for(i=0;i<8;i++)
	{
		g_Ini.iSetProNum[i] = i+1;		 //设置端口号探针端口号1-8的映射对应板子上的 pro 1-8
	}
...
BOOL	SysParaCheck()
{
	...
	for(i=0;i<MAXCH;i++)
	{
		...
		if(!Check_DataInt(g_Ini.iAxisNameNo[i],0,10))
			return FALSE;

		if(!Check_DataInt(g_Ini.iHardLimitSwitch[i],0,1))
			return FALSE;	

		if(!Check_DataInt(g_Ini.iPhyAxis[i],0,4))
			return FALSE;
	...
	for(i=0;i<8;i++)
	{
		if(!Check_DataInt(g_Ini.iSetProNum[i],1,8))
			return FALSE;
	}

	if(!Check_DataInt(g_Ini.iWaitSignal,0,8))
		return FALSE;

	if(!Check_DataInt(g_Ini.iProDelay,0,9999))
		return FALSE;
	//系统参数检测
	if(!Check_DataInt(g_Ini.iAxisCount,2,6))
		return FALSE;
	...
	if(!Check_DataInt(g_Ini.iCyldMode,0,2))
		return FALSE;

	if(!Check_DataInt(g_Ini.iCyldOrOrigin,0,1))
		return FALSE;

	if(!Check_DataInt(g_Ini.iEnterNumber,0,1))
		return FALSE;

	if(!Check_DataLong(g_Ini.lRotatorRate,0,1000000))
		return FALSE;	
	...
	if(!Check_DataInt(g_Ini.iMachineType,0,6))
		return FALSE;
	...
	if(!Check_DataInt(g_Ini.iSwhSingleIo,0,1))
		return FALSE;	
	...
	if(!Check_DataInt(g_Ini.iSafeDoor,0,2))
		return FALSE;
	...
	if(!Check_DataInt(g_Ini.iIOWireAccConfig_OUT,0,255))
		return FALSE;
	if(!Check_DataInt(g_Ini.iIOSafeDoorConfig_IN,0,255))
		return FALSE;
	...
	if(!Check_DataInt(g_Ini.iIOSendLineMConfig_IN,0,255))
		return FALSE;
	if(!Check_DataInt(g_Ini.iWorkAxisNo,0,6))
		return FALSE;
	if(!Check_DataLong(g_Ini.iWorkAxisTMolecular,0,999999L))
		return FALSE;
	return  TRUE;
}
...
void WritePosToRam(INT16S ch, INT32S pos)
{
 *((volatile signed int *)(0x28000204+ch*4)) = pos;
}
...
INT32S ReadPosFromRam(INT16S ch)
{
	...
	return *((volatile signed int *)(0x28000204+ch*4));
}
