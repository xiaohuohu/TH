...
void CDispDir_Message(INT8S *message,BOOL bline)
{
	...
	if(message)
	{
		...
		CDC_OutText24(x1+6,y1+4,message,BLACKCOLOR,BGCOLOR);
...
void CDispDir_ButtonStatus( INT16S ibtn,INT16S init)
{
	...
	if(init)
	{
		...
		//	CDC_OutCenTextKzk24(rect[0]," 1-Copy",YELLOWCOLOR,BLACKCOLOR);
			CDC_OutCenText2(rect[0]," 1-Copy",YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[1],"2-Paste",YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[2]," 3-Del",YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[3]," 4-Back",YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[4]," 5-Root",YELLOWCOLOR,g_nBk);
		}
		else
		{
			CDC_OutCenText2(rect[0],tr("1-复制"),YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[1],tr("2-粘贴"),YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[2],tr("3-删除"),YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[3],tr("4-上一层"),YELLOWCOLOR,g_nBk);
			CDC_OutCenText2(rect[4],tr("5-根目录"),YELLOWCOLOR,g_nBk);
...
//	CDC_OutText_UTF(x2+5,y1+1,"0.0%",BLUECOLOR,BGCOLOR,KZK_24);
	CDC_OutText24(x2+5,y1+1,"0.0%",REDCOLOR,DARKBLUECOLOR);
...
//	CDC_OutText_UTF(x2+5,y1+1,Percent,BLUECOLOR,BGCOLOR,KZK_24);
	CDC_OutText24(x2+5,y1+1,Percent,REDCOLOR,DARKBLUECOLOR);
...
void CDispDir_DrawPicture(INT16S Type,INT16S x,INT16S y)
{
	...
	//	CDC_OutText_UTF(x+18,y+12,"?",REDCOLOR,WHITECOLOR,KZK_24);
		CDC_OutText24(x+18,y+12,"?",REDCOLOR,WHITECOLOR);
	}
