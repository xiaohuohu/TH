...
#define OS_CFG_H
                                       ...
                                       /* ---------------------- MISCELLANEOUS ----------------------- */
#define OS_APP_HOOKS_EN           0u//1u   /* Application-defined hooks are called from the uC/OS-II hooks */
...
#define OS_MAX_EVENTS             300u   //50//10u   /* Max. number of event control blocks in your application      */
#define OS_MAX_FLAGS              50u    //5u   /* Max. number of Event Flag Groups    in your application      */
#define OS_MAX_MEM_PART           50u    //8u//5u   /* Max. number of memory partitions                             */
#define OS_MAX_QS                 50u    //4u   /* Max. number of queue control blocks in your application      */
#define OS_MAX_TASKS              56u    //30//20u   /* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TLS_TBL_SIZE           0u   /* Size of Thread-Local Storage Table                           */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    1024//256u   /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   4096//256u   /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   1024//256u   /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_TIME_TICK_HOOK_EN      0u//1u   /*     Include code for OSTimeTickHook()                        */
