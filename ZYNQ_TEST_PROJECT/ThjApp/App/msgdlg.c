...
INT8S		g_pszButton1[10]="确定";
INT8S   	g_pszButton2[10]="取消";
...
void   CMsgDlg_Create()
{
	...
	rect.top = g_iDlgTop+30;
	rect.right = g_iDlgLeft+g_iDlgWidth;
	rect.bottom = g_iDlgTop+g_iDlgHeight-40;
	
	CDC_DrawWin24(g_iDlgLeft,g_iDlgTop,g_iDlgWidth,g_iDlgHeight,g_pszDlgWindowText);
	CDC_OutCenText24(rect,g_pszDlgDispStr,g_lDlgTextColor,DARKBLUECOLOR);
