...
void   CSetDog_Create(void)
{
	...
	{
		CDC_OutText24(g_iDlgLeft+30,j+=SETDOGHOFFSET,g_bEnglish?"Factory ID":"公司级电脑编号:",g_nTableBk,g_TextColor7);
		CDC_OutText24(g_iDlgLeft+30,j+=SETDOGHOFFSET,g_bEnglish?"Valid Days":"使用天数:",g_nTableBk,g_TextColor7);
		//CDC_OutText24(g_iDlgLeft+30,j+=SETDOGHOFFSET,g_bEnglish?"Login Password":"登录密码:",WHITECOLOR,g_nBk);
	}
