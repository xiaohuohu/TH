...
//	CDC_OutText24(g_iDlgLeft+15,g_iDlgTop+50,g_pszDlgDispStr,g_lDlgTextColor,g_nBk);
	CDC_OutText24(g_iDlgLeft+30,g_iDlgTop+50,g_pszDlgDispStr,g_lDlgTextColor,DARKGRAYCOLOR);
