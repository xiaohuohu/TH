...
#if   CANSIG_MAX_WIDTH == 1
typedef CPU_INT08U CANSIG_VAL_T;
#elif CANSIG_MAX_WIDTH == 2
typedef CPU_INT16U CANSIG_VAL_T;
#elif CANSIG_MAX_WIDTH == 4
...
*/
/*------------------------------------------------------------------------------------------------*/
#define CANSIG_NO_TIMESTAMP  0x80
...
*/
/*------------------------------------------------------------------------------------------------*/
#define CANSIG_CALLBACK_WRITE_ID 0x00000001
#define CANSIG_CALLBACK_READ_ID  0x00000002
