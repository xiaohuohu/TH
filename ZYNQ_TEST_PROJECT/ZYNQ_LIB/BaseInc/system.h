...
#define ZYNQ_LIB_VER		162//161//160//159//158//157//155 //149 //146 //143 //142 //141 //140 //134
...
#define LcdType_TH08A      2
#define LcdType_CNC502     3
...
#define DT_7010				0x7010
#define DT_1600R			0x16CC

#define DT_CNC9640B         0x964B   //版本号：B001

#define DT_6862_96xx    0x6862   //CNC9620B,9640B,9650B,9810B,aixing9640B
#define DT_TH08HA_KB48   0xB048
...
#define MT_TEST0332			0x5a10	//测试用的核心板

#define MT_TH08A			0x4a11
#define MT_TH08R            0x4a12

//6862硬件板子
#define MT_CNC9620B			0x5a11
#define MT_CNC9640B			0x5a12
#define MT_CNC9650B			0x5a13


#define MT_CNC9810B			0x5a14

#define MT_AoXin9640B			0x5a15
#define MT_NTC04B			0x5a16  // MT_NTC03B  MT_NTC04B

#define MT_NTC02B          0x5a17

#define MT_TH08HA_KB48      0x5a20
 ...
 * 					>100： BIOS版本号
*********************************************/
int A9_2440_SetMachineType(INT16U Type);
...
/*********************************************
 * 函数名：			int AppProg_Cpu1(void);
 * 主要功能:    		将"0:\\ADT\\Motion.bin"更新到Flash空间，重启即可完成程序更新
 * 输入参数：		无
 * 输出参数 :		无
 * 返回值 :
 *   				1 - 失败
 ...
 * 返回值 :			无
*********************************************/
void Lib_Delay(INT32U time);

//void MainInit(INT8U MACHTYPE);
