...
typedef struct adt_uartlite_regs{
	u32 comm_test;		/*0x00*/
	u32 uart_speed;		/*0x04*/
	u32 tx_data;		/*0x08*/
	u32 rx_data;		/*0x0c*/
	...
	u32 ctrl_reg;		/*0x1c*/
	u32 filter;			/*0x20*/
}__attribute__((__packed__)) adt_uartlite_controller_regs;
...
adt_uartlite_controller_regs *get_adt_uartlite_io_base(int port);

int Adt_UartLite_ClearInterrupt(int port);
